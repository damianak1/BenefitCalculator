        ...
        <div class="mt-5">
            <form @submit="calculateBenefits">
                <div class="form-group">
                    ...
                    <input type="text" v-model="model.ParticipantBenefitRecord.Name" class="form-control mb-3" required @change="clearResults" />
                </div>
                <div class="form-group">
                    <button type="button" class="btn btn-primary mb-3 w-50" @click="addClick()"> Add Dependent </button>
                </div>
                <div v-for="(dependent, index) in model.DependencyBenefitRecords" :key="index">
                    <div class="form-group">
                        <div class="input-group w-100 mb-3">
                            <input type="text" class="form-control" placeholder="Enter name of dependent" v-model="dependent.Name" @change="clearResults">
                ...
                <button type="submit" class="btn btn-primary w-50 mt-4"> Calculate Cost</button>
